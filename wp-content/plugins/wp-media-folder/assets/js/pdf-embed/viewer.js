...
const defaultOptions = {
  ...
  imageResourcesPath: {
    value: wpmf_pdf_embed_obj.imageResourcesPath,
    kind: OptionKind.VIEWER
  },
  maxCanvasPixels: {
    value: 16777216,
  ...
  workerSrc: {
    value: wpmf_pdf_embed_obj.workerSrc,
    kind: OptionKind.WORKER
  }
};
{
  ...
  defaultOptions.sandboxBundleSrc = {
    value: wpmf_pdf_embed_obj.sandboxBundleSrc,
    kind: OptionKind.VIEWER
  };
}
...
const DEFAULT_L10N_STRINGS = {
  ...
  document_properties_date_string: "2024-07-04 10:18:47, {{time}}",
  ...
  annotation_date_string: "2024-07-04 10:18:47, {{time}}",
